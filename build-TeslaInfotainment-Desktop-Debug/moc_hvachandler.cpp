...
#include "../TeslaInfotainment/Controllers/hvachandler.h"
...
void HVACHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        HVACHandler *_t = static_cast<HVACHandler *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (HVACHandler::*_t)(int );
...
const QMetaObject HVACHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_HVACHandler.data,
      qt_meta_data_HVACHandler,  qt_static_metacall, nullptr, nullptr}
};
